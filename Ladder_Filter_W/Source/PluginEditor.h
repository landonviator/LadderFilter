...
class Ladder_Filter_WAudioProcessorEditor : public juce::AudioProcessorEditor
{
public:
    Ladder_Filter_WAudioProcessorEditor(Ladder_Filter_WAudioProcessor&);
    ~Ladder_Filter_WAudioProcessorEditor() override;
...
private:
    ...
    Ladder_Filter_WAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Ladder_Filter_WAudioProcessorEditor)
};
